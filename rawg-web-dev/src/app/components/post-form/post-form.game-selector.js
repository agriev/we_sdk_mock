...
import './post-form.game-selector.styl';
...
class ReviewFormGameSelector extends React.Component {
  ...
  render = () => {
    ...
    return (
      <div className="post-form__game-selector">
        {!game && (
          <InputSearchMain
        ...
        {game && (
          <div className="post-form__game-selector__selected-game">
            <div
              className="post-form__game-selector__selected-game__image"
              style={{ backgroundImage: `url(${game.background_image})` }}
            />
            <div className="post-form__game-selector__selected-game__name">
              <div>{game.name}</div>
              <Platforms
            ...
            <div
              className="post-form__game-selector__selected-game__close"
        ...
        <Dropdown
          ...
          className="post-form__game-selector__search-results"
          containerClassName="post-form__game-selector__container_search-results"
          kind="search-results"
          opened={value !== ''}
